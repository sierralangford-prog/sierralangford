...
export const projects: Project[] = [
  ...
  },
  {
    ...
    related: ["strive-society", "earlier-writing-archive"],
  },
  {
    slug: "strive-society",
  ...
  },
  {
    ...
    visibility: "Archive only",
    visualNote: SAMPLE_NOTE,
    related: ["digital-motif", "earlier-writing-archive"],
  },
  {
    slug: "earlier-writing-archive",
    title: "Earlier Client Writing Archive",
    organization: "Various clients",
    period: "2019 – 2024",
    role: "Writer and Content Strategist",
    industries: ["Retail", "Professional Services", "Cybersecurity", "Home Services"],
    categories: ["Earlier Career Archive", "Content and Editorial"],
    summary:
      "An archive of earlier writing and marketing work across small business, retail, cybersecurity and community organizations.",
    challenge:
      "Small businesses needed search visibility and consistent voice without a marketing department.",
    owned: ["Blog strategy and writing", "Email campaigns", "SEO planning", "Community communications"],
    audiences: ["Local customers", "B2B buyers", "Alumni and community members"],
    deliverables: [
      "Advantage Shutters blog strategy, including interior plantation shutter, exterior shutter and energy efficiency articles",
      "Brentwood Jewelry blog program",
      "CyberProtex blogs and weekly emails",
      "ABH Connect blogs and email campaigns",
      "Kappa Kappa Gamma alumni and community communications",
    ],
    tools: ["WordPress", "Mailchimp", "Google Analytics"],
    results: ["A multi year library of published SEO and email content across industries"],
    headlineResult: "A multi year published writing library across small business and B2B",
